...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-5">
        <div>
            <h1 class="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Create New Problem</h1>
            <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Design a new programming problem for contestants.</p>
        </div>
    </div>
