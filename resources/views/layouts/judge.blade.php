                ...
                <div class="flex items-center gap-4 lg:gap-8">
                    ...
                    <nav class="hidden lg:flex items-center gap-1">
                        <a href="{{ route('judge.dashboard') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::routeIs('judge.dashboard') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">Judge
                            Panel</a>
                        <a href="{{ route('problems.create') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::routeIs('problems.create') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">New
                            Problem</a>
                        <a href="{{ route('problems.index') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ (Request::is('problems') || Request::routeIs('problems.show') || Request::routeIs('problems.edit')) && !Request::routeIs('problems.create') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">My
                            Problems</a>
                        <a href="{{ route('judge.test-cases.index') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::routeIs('judge.test-cases.index') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">Test
                            Cases</a>
                        ...
                        <a href="{{ route('judge.blogs.index') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::routeIs('judge.blogs.*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">My
                            Blogs</a>
                    </nav>
                </div>
                ...
                <div class="flex items-center gap-1 sm:gap-4 shrink-0">
                    ...
                    <div class="lg:hidden flex items-center" x-data="{ mobileMenuOpen: false }">
                        ...
                        <div x-show="mobileMenuOpen" @click.outside="mobileMenuOpen = false" x-transition
                            ...
                            style="display: none;">
                            <a href="{{ route('judge.dashboard') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::routeIs('judge.dashboard') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">Judge
                                Panel</a>
                            <a href="{{ route('problems.create') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::routeIs('problems.create') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">New
                                Problem</a>
                            <a href="{{ route('problems.index') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ (Request::is('problems') || Request::routeIs('problems.show') || Request::routeIs('problems.edit')) && !Request::routeIs('problems.create') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">My
                                Problems</a>
                            <a href="{{ route('judge.test-cases.index') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::routeIs('judge.test-cases.index') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">Test
                                Cases</a>
                            <a href="{{ route('submissions.index') }}"
                            ...
                            <a href="{{ route('judge.blogs.index') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::routeIs('judge.blogs.*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">My
                                Blogs</a>
                        </div>
                    </div>
                </div>
