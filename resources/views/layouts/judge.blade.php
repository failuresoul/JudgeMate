            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <nav class="hidden md:flex items-center gap-1">
                        <a href="{{ route('judge.dashboard') }}" class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::routeIs('judge.dashboard') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">Judge Panel</a>
                        <a href="{{ route('problems.create') }}" class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::routeIs('problems.create') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">New Problem</a>
                        <a href="{{ route('problems.index') }}" class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ (Request::is('problems') || Request::routeIs('problems.show') || Request::routeIs('problems.edit')) && !Request::routeIs('problems.create') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">My Problems</a>
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    ...
                    <div class="md:hidden flex items-center" x-data="{ mobileMenuOpen: false }">
                        ...
                        <div x-show="mobileMenuOpen" @click.outside="mobileMenuOpen = false" x-transition class="absolute top-16 left-0 right-0 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-lg p-4 flex flex-col gap-2 z-50" style="display: none;">
                            <a href="{{ route('judge.dashboard') }}" class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::routeIs('judge.dashboard') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">Judge Panel</a>
                            <a href="{{ route('problems.create') }}" class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::routeIs('problems.create') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">New Problem</a>
                            <a href="{{ route('problems.index') }}" class="px-3 py-2 rounded-lg text-sm font-medium {{ (Request::is('problems') || Request::routeIs('problems.show') || Request::routeIs('problems.edit')) && !Request::routeIs('problems.create') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">My Problems</a>
