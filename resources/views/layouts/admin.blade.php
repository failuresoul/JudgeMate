            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center gap-4 lg:gap-8">
                    ...
                    <a href="/" class="flex items-center gap-1.5 sm:gap-2 group">
                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-tr from-indigo-600 to-violet-500 shadow-lg shadow-indigo-500/20 group-hover:scale-105 transition-transform duration-200">
                            <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M14.25 9.75L16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" />
                            </svg>
                        </div>
                        <span class="hidden min-[375px]:inline-block text-xl font-bold tracking-tight bg-gradient-to-r from-slate-900 via-slate-700 to-indigo-600 dark:from-white dark:via-slate-100 dark:to-indigo-400 bg-clip-text text-transparent truncate">Judge<span class="text-indigo-600 dark:text-indigo-500">Mate</span></span>
                    </a>

                    <!-- Desktop Navigation Links -->
                    <nav class="hidden lg:flex items-center gap-1">
                        <a href="{{ route('admin.dashboard') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::routeIs('admin.dashboard') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">Dashboard</a>
                        <a href="{{ route('problems.index') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::is('problems*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">Problems</a>
                        ...
                        <a href="{{ route('admin.users.index') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::routeIs('admin.users.*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">Users</a>
                        ...
                        <a href="{{ route('leaderboard') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::is('leaderboard*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">Leaderboard</a>
                        <a href="{{ route('admin.blogs.index') }}"
                            class="px-3 py-2 rounded-lg text-sm font-semibold transition-colors {{ Request::routeIs('admin.blogs.*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}">Review
                            Blogs</a>
                    </nav>
                </div>
                ...
                <div class="flex items-center gap-1 sm:gap-4 shrink-0">
                    ...
                    <div class="lg:hidden flex items-center" x-data="{ mobileMenuOpen: false }">
                        ...
                        <div x-show="mobileMenuOpen" @click.outside="mobileMenuOpen = false" x-transition
                            ...
                            style="display: none;">
                            <a href="{{ route('admin.dashboard') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::routeIs('admin.dashboard') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">Dashboard</a>
                            <a href="{{ route('problems.index') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::is('problems*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">Problems</a>
                            <a href="{{ route('contests.index') }}"
                            ...
                            <a href="{{ route('admin.users.index') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::routeIs('admin.users.*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">Users</a>
                            <a href="{{ route('submissions.index') }}"
                            ...
                            <a href="{{ route('leaderboard') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::is('leaderboard*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">Leaderboard</a>
                            <a href="{{ route('admin.blogs.index') }}"
                                class="px-3 py-2 rounded-lg text-sm font-medium {{ Request::routeIs('admin.blogs.*') ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">Review
                                Blogs</a>
                        </div>
                    </div>
                </div>
